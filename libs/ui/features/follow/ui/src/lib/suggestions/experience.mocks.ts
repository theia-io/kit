...
export const DB_USERS_20240713 = [
  {
        ...
        projects: [
          {
            ...
            description:
              'Developed a full-stack e-commerce platform using Java and Spring Boot.',
              ...
              experience: [
                {
                  ...
                  description:
                    'Developed and maintained software applications for Google.',
    ...
    privateFields: ['password', 'services'],
  },
  {
    _id: {
